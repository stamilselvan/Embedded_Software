...
OS_STK OLD_Stack[TASK_STACKSIZE];
OS_STK DYNAMIC_UTI_Stack[TASK_STACKSIZE];
  ...
  err = OSTaskCreateExt(
   ...
   err = OSTaskCreateExt(
    ...
    err = OSTaskCreateExt(
       ...
       NULL,        // Pointer to argument that is
                    // passed to task
       &OLD_Stack[TASK_STACKSIZE-1], // Pointer to top
                             // of task stack
       OLD_PRIO,
       OLD_PRIO,
       (void *)&OLD_Stack[0],
     ...
     err = OSTaskCreateExt(
       ...
       NULL,        // Pointer to argument that is
                    // passed to task
       &DYNAMIC_UTI_Stack[TASK_STACKSIZE-1], // Pointer to top
                             // of task stack
       DYNAMIC_UTI_PRIO,
       DYNAMIC_UTI_PRIO,
